...
RSpec.describe SignaturesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: signature.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      signature = Signature.create! valid_attributes
      get :edit, params: {id: signature.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Signature" do
        expect {
          post :create, params: {signature: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {signature: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested signature" do
        signature = Signature.create! valid_attributes
        put :update, params: {id: signature.to_param, signature: new_attributes}, session: valid_session
        signature.reload
      ...
      it "redirects to the signature" do
        signature = Signature.create! valid_attributes
        put :update, params: {id: signature.to_param, signature: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        signature = Signature.create! valid_attributes
        put :update, params: {id: signature.to_param, signature: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested signature" do
      signature = Signature.create! valid_attributes
      expect {
        delete :destroy, params: {id: signature.to_param}, session: valid_session
      }.to change(Signature, :count).by(-1)
    end
